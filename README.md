...
- Solar production is derived from inverter output less its battery power (`solar = inverter - battery`), on either wiring: with no grid, the inverter's output is everything the site draws from it
